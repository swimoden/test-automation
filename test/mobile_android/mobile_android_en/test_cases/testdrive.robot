...
I Succeed to make a Request test drive from brand
  ...
  I can make a test drive  Mohamd Amine  6677  66771100  testAuto@test.com
...
I Succeed to make a Request test drive with delivery from dashboard
  [Tags]  Ios_en_callback_brand
  I can navigate to List Brand
  I can navigate to List of models  BYD
  I can navigate to the details of the model  BYD  Tang
  I can make a test drive with delivery  Mohamd Amine  6677  66771100  testAuto@test.com
  I go back to menu from model detail
...
I can make a test drive
  [Arguments]  ${nom_user}  ${false_phone_number}  ${phone_number}  ${email}
  I can see model Actions buttons
...
I can make a test drive with delivery
  [Arguments]  ${nom_user}  ${false_phone_number}  ${phone_number}  ${email}
  I can see model Actions buttons
