...
Force Tags  Ios  Ios_en  showlocation

*** Variables ***

*** Test Cases ***
I Succeed to show location
  [Tags]  Ios_en_showlocation_off_ligne
  I can navigate to List Brand
  I can navigate to List of models  Nissan
  I can navigate to show Location screen
  I can see pin in maps 
  I can change camera position
  I can show direction  
  I should be in google map  
  [Teardown]  NONE

*** Keywords ***
I can navigate to show Location screen
  Click Element  xpath=//XCUIElementTypeStaticText[@name="Main Showroom"]

I can change camera position
  Click Element  xpath=//XCUIElementTypeStaticText[@name="Nissan: SHUWAIKH SERVICE CENTER"]

I can show direction
  Click Element  xpath=(//XCUIElementTypeButton[@name="Direction"])[1]

I should be in google map
  Wait Until Element Is Visible  xpath=//XCUIElementTypeStaticText[@name="Upgrade to a smarter Google Maps"]
...
I can see pin in maps
  Wait Until Element Is Visible  xpath=//XCUIElementTypeStaticText[@name="Nissan: SHUWAIKH SERVICE CENTER"]
